...
**>>** `Quick start guide (covers most basic functions of PSITIP) <https://nbviewer.jupyter.org/github/cheuktingli/psitip/tree/master/examples/learnit_quickstart.ipynb>`_ **<<** 
...
**>>** `Learn Information Theory with PSITIP (nbviewer, READ ONLY) <https://nbviewer.jupyter.org/github/cheuktingli/psitip/tree/master/examples/table_of_contents.ipynb>`_ **<<** 
...
- Handling first-order logic statements on random variables (involving arbitrary combinations of information inequalities, existence, for all, and, or, not, implication, etc).
